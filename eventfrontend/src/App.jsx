          ...
          <div className>
            <div className="flex flex-wrap justify-between">
              <div className="items-center ">
                <h1 className="font-semibold text-xl mb-0 block dark:text-slate-100">Dashboard</h1>
                <ol className="list-reset flex text-sm">
                  <li><a href="#" className="text-gray-500">T-Wind</a></li>
                  <li><span className="text-gray-500 mx-2">/</span></li>
                  <li className="text-gray-500">Dashboard</li>
                  <li><span className="text-gray-500 mx-2">/</span></li>
                  <li className="text-blue-600 hover:text-blue-700">Analytics</li>
                </ol>
              </div>
        ...
        <div className="h-full bg-white dark:bg-slate-800 shadow rounded-md w-full p-4 relative overflow-hidden grid md:gap-4 lg:gap-2 xl:gap-4 md:grid-cols-1 lg:grid-cols-4">
          <div className="md:col-span-4 lg:col-span-4 xl:col-span-4 self-center">
            ...
            <div className="text-center py-2">
              <button className="px-3 py-2 lg:px-4 bg-blue-500 text-white text-sm font-semibold rounded hover:bg-blue-600">Start Auction</button>
            </div>
          </div>
        </div> 
      </div>
        ...
        <div className="w-full relative overflow-hidden">                   
          <div className="p-0 xl:p-4">                        
            ...
            <div id="myTabContent">
                  ...
                  <div className="col-span-10 md:col-span-3 lg:col-span-3 xl:col-span-2">
                    <div className="card">
                      ...
                      <div className="card-body pt-0">
                        <div className="flex justify-between">
                          <div className="self-center">
                            <h6 className="font-medium text-[15px] text-slate-700 block dark:text-slate-300">Timeless Ape Club</h6>
                  ...
                  <div className="col-span-10 md:col-span-3 lg:col-span-3 xl:col-span-2">
                    <div className="card">
                      ...
                      <div className="card-body pt-0">
                        <div className="flex justify-between">
                          <div className="self-center">
                            <h6 className="font-medium text-[15px] text-slate-700 block dark:text-slate-300">Mmoking Ape Club</h6>
              ...
              <div className="hidden" id="Auctions" role="tabpanel" aria-labelledby="Auctions-tab">
                <div className="grid md:grid-cols-9 lg:grid-cols-9 xl:grid-cols-10 gap-4">
                  <div className="col-span-10 md:col-span-3 lg:col-span-3 xl:col-span-2">
                    <div className="card">
                      <div className="card-body relative">
                        ...
                        <a href="#">
                          <div className="flex">
                            ...
                            <div className="flex-shrink self-center ml-2">
                              <h6 className="font-medium text-base text-slate-700 block dark:text-slate-300">James Walker</h6>
                      ...
                      <div className="card-body">
                        <a href="#">
                          <div className="flex">
                            ...
                            <span className="absolute left-0 h-3 w-3 rounded-full bg-green-500 p-2 flex justify-center items-center border-2 border-white"><i className="ti ti-check text-white" /></span>
                            <div className="flex-shrink self-center ml-2">
                              <h6 className="font-medium text-base text-slate-700 block dark:text-slate-300">Beatrice Smith</h6>
                              <span className="text-xs text-slate-400 font-medium block">$2300,900</span>
                            </div>
                          </div>
                        </a>                                                
                      ...
                      <div className="card-body">
                        <a href="#">
                          <div className="flex">
                            ...
                            <span className="absolute left-0 h-3 w-3 rounded-full bg-green-500 p-2 flex justify-center items-center border-2 border-white"><i className="ti ti-check text-white" /></span>
                            <div className="flex-shrink self-center ml-2">
                              <h6 className="font-medium text-base text-slate-700 block dark:text-slate-300">Marlon Martin</h6>
                              <span className="text-xs text-slate-400 font-medium block">$2300,900</span>
                            </div>
                          </div>
                        </a>                                                
                      ...
                      <div className="card-body">
                        <a href="#">
                          <div className="flex">
                            ...
                            <span className="absolute left-0 h-3 w-3 rounded-full bg-green-500 p-2 flex justify-center items-center border-2 border-white"><i className="ti ti-check text-white" /></span>
                            <div className="flex-shrink self-center ml-2">
                              <h6 className="font-medium text-base text-slate-700 block dark:text-slate-300">Manuel Browne</h6>
                              <span className="text-xs text-slate-400 font-medium block">$2300,900</span>
                            </div>
                          </div>
                        </a>                                                
                      ...
                      <div className="card-body">
                        <a href="#">
                          <div className="flex">
                            ...
                            <span className="absolute left-0 h-3 w-3 rounded-full bg-green-500 p-2 flex justify-center items-center border-2 border-white"><i className="ti ti-check text-white" /></span>
                            <div className="flex-shrink self-center ml-2">
                              <h6 className="font-medium text-base text-slate-700 block dark:text-slate-300">William Eastman</h6>
                              <span className="text-xs text-slate-400 font-medium block">$2300,900</span>
                            </div>
                          </div>
                        </a>                                                
                      ...
                      <div className="card-body">
                        <a href="#">
                          <div className="flex">
                            ...
                            <span className="absolute left-0 h-3 w-3 rounded-full bg-green-500 p-2 flex justify-center items-center border-2 border-white"><i className="ti ti-check text-white" /></span>
                            <div className="flex-shrink self-center ml-2">
                              <h6 className="font-medium text-base text-slate-700 block dark:text-slate-300">Jonathan Ngo</h6>
                              <span className="text-xs text-slate-400 font-medium block">$2300,900</span>
                            </div>
                          </div>
                        </a>
                      ...
                      <div className="card-body">
                        <a href="#">
                          <div className="flex">
                            ...
                            <span className="absolute left-0 h-3 w-3 rounded-full bg-green-500 p-2 flex justify-center items-center border-2 border-white"><i className="ti ti-check text-white" /></span>
                            <div className="flex-shrink self-center ml-2">
                              <h6 className="font-medium text-base text-slate-700 block dark:text-slate-300">Derrick Weiss</h6>
                              <span className="text-xs text-slate-400 font-medium block">$2300,900</span>
                            </div>
                          </div>
                        </a>                                                
                      ...
                      <div className="card-body">
                        <a href="#">
                          <div className="flex">
                            ...
                            <span className="absolute left-0 h-3 w-3 rounded-full bg-green-500 p-2 flex justify-center items-center border-2 border-white"><i className="ti ti-check text-white" /></span>
                            <div className="flex-shrink self-center ml-2">
                              <h6 className="font-medium text-base text-slate-700 block dark:text-slate-300">Antonio Cooke</h6>
                              <span className="text-xs text-slate-400 font-medium block">$2300,900</span>
                            </div>
                          </div>
                        </a>                                                
                      ...
                      <div className="card-body">
                        <a href="#">
                          <div className="flex">
                            ...
                            <span className="absolute left-0 h-3 w-3 rounded-full bg-green-500 p-2 flex justify-center items-center border-2 border-white"><i className="ti ti-check text-white" /></span>
                            <div className="flex-shrink self-center ml-2">
                              <h6 className="font-medium text-base text-slate-700 block dark:text-slate-300">Robert Chase</h6>
                              <span className="text-xs text-slate-400 font-medium block">$2300,900</span>
                            </div>
                          </div>
                        </a>                                                
                      ...
                      <div className="card-body">
                        <a href="#">
                          <div className="flex">
                            ...
                            <span className="absolute left-0 h-3 w-3 rounded-full bg-green-500 p-2 flex justify-center items-center border-2 border-white"><i className="ti ti-check text-white" /></span>
                            <div className="flex-shrink self-center ml-2">
                              <h6 className="font-medium text-base text-slate-700 block dark:text-slate-300">Roberto Bowen</h6>
                              <span className="text-xs text-slate-400 font-medium block">$2300,900</span>
                            </div>
                          </div>
                        </a>                                                
