...
document.querySelectorAll(".dropdown").forEach(function (n) {
  n.querySelectorAll(".dropdown-toggle").forEach(function (t) {
    if (t.dataset.listenerAttached === "true") return; // ✅ already has listener
    ...
    t.addEventListener("click", function (e) {
      ...
      if (!t.classList.contains("block")) {
        ...
        dismissDropdownMenu(); // make sure this doesn't re-run too!
    ...
    _createClass(e, [
      {
        ...
        value: function () {
          document.querySelectorAll(".navbar").length &&
            document.querySelectorAll(".navbar li a").forEach(function (e, t) {
              var n,
                o = window.location.href.split(/[?#]/)[0];
              o.includes(".html") || (o += "index.html"),
                e.href === o &&
                  ((n = e).classList.add("active"),
                  n.parentNode.parentNode.classList.add("active"),
